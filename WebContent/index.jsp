...
<title>The offensive game</title>
<jsp:include page="analytics.jsp" />

<link rel="stylesheet" type="text/css" href="css/cah.css" media="screen" />

</head>
<body>
<h1>
  <dfn style="border-bottom: 1px dotted black"
  title="Offend people as much as possible.">The Offensive
  </dfn> Card Game
</h1>
<h3>Based on the game Cards Against Humanity.</h3>
<p>
...
<p>
  The Offensive Game is a Cards Against Humanity clone, which is available at
  ...
  <a href="https://github.com/ksherm337/PretendYoureXyzzy">GitHub</a>. For full license
